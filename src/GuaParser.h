...
public:
  ...
  enum {
    RuleProgram = 0, RuleStatement = 1, RuleIncludeStmt = 2, RuleVarDecl = 3, 
    RuleAssignment = 4, RuleExprStmt = 5, RuleIfStmt = 6, RuleWhileStmt = 7, 
    RuleBlock = 8, RuleFunctionDecl = 9, RuleParamList = 10, RuleClassDecl = 11, 
    RuleClassBody = 12, RuleConstructorDecl = 13, RuleDeconstructorDecl = 14, 
    RuleInterfaceImplDecl = 15, RuleInterfaceDecl = 16, RuleInterfaceBody = 17, 
    RuleFunctionSignature = 18, RuleExpression = 19, RuleArgList = 20
  };
  ...
  class DeconstructorDeclContext;
  class InterfaceImplDeclContext;
  ...
  public:
    ...
    std::vector<DeconstructorDeclContext *> deconstructorDecl();
    DeconstructorDeclContext* deconstructorDecl(size_t i);
    std::vector<FunctionDeclContext *> functionDecl();
    FunctionDeclContext* functionDecl(size_t i);
    std::vector<VarDeclContext *> varDecl();
    VarDeclContext* varDecl(size_t i);
    std::vector<InterfaceImplDeclContext *> interfaceImplDecl();
    InterfaceImplDeclContext* interfaceImplDecl(size_t i);
  ...
  class  DeconstructorDeclContext : public antlr4::ParserRuleContext {
  public:
    DeconstructorDeclContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    BlockContext *block();
  ...
  DeconstructorDeclContext* deconstructorDecl();

  class  InterfaceImplDeclContext : public antlr4::ParserRuleContext {
  public:
    InterfaceImplDeclContext(antlr4::ParserRuleContext *parent, size_t invokingState);
    virtual size_t getRuleIndex() const override;
    antlr4::tree::TerminalNode *IDENTIFIER();
  ...
  InterfaceImplDeclContext* interfaceImplDecl();
  ...
  public:
    ...
    virtual size_t getRuleIndex() const override;
    std::vector<FunctionSignatureContext *> functionSignature();
    FunctionSignatureContext* functionSignature(size_t i);
  ...
  class  MemberFunctionCallExprContext : public ExpressionContext {
  public:
    MemberFunctionCallExprContext(ExpressionContext *ctx);
